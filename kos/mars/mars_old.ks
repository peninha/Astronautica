...
local setup_time to 90. // setup time for the burn
...
local stage_mass to 1.042. // mass of the spin burn stage
...
local first_burn_dv to (2569+600). // delta-v for the first burn

print "           burn delay: " + burn_delay at (0,19).
...
for engine in engine_list {
    if engine:ignition{ // Add active engines to the list.
        ...
        print engine:name at (0,23+i).
        set i to i + 1.
    }
}
print "Active engines: " + active_engines:length at (0,22).
...
local half_dv_time to calc_burn_time(first_burn_dv/2).
...
print "            RCS ISP: " + rcs_isp at (0,11).
print "            RCS Thrust: " + rcs_thrust at (0,12).
...
// ############## Engines spooling up ##############
set t0 to time:seconds.
print "    burn initial mass: " + ship:mass at (0,20).
print "             dry mass: " + ship:drymass at (0,21).
...
until burn_dv >= target_dv + 1000 - stop_burn_tol {
    local t1 to time:seconds.  
    ...
    print_burn_time(t_burn).
    print_alignment().
    print "            Target Dv: " + target_dv at (0,14).
    print "      Total Burned Dv: " + burn_dv at (0,15).
    print "           deltav:mag: " + nd:deltav:mag at (0,16).
